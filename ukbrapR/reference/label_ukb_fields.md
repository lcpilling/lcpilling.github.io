...
This function updates a data frame of UK Biobank data field with
information from the Schema.

It is in effect a wrapper to apply ukbrapR::label_ukb_field() to each
variable in a data frame that looks like a UK Biobank field.

Only recognised fields are modified (variables named things like
"p54_i0"). Other variables are ignored.
